      ...
      <div className={s.main}>
        <div className={s.mainItem}>
          ...
          <div className={s.overlay}>
            <a href="https://tania2501.github.io/samurai-way-main/">
              <img src={arr} alt="#" />
            </a>
          </div>
          <a href="https://tania2501.github.io/samurai-way-main/">
        ...
        <div className={s.mainItem}>
          ...
          ></div>
          <div className={s.overlay}>
            <a href="https://tania2501.github.io/1-todolist/">
              <img src={arr} alt="#" />
            </a>
          </div>
        ...
        <div className={s.mainItem}>
          ...
          ></div>
          <div className={s.overlay}>
            <a href="https://tania2501.github.io/counter-two/">
              <img src={arr} alt="#" />
            </a>
          </div>
        ...
        <div className={s.mainItem}>
          ...
          ></div>
          <div className={s.overlay}>
            <a href="https://tania2501.github.io/woom/">
              <img src={arr} alt="#" />
            </a>
          </div>
